# Identity\-based policy examples for Amazon HealthLake<a name="security_iam_id-based-policy-examples"></a>
...
+ [Using the Amazon HealthLake console](#security_iam_id-based-policy-examples-console)
...
## Using the Amazon HealthLake console<a name="security_iam_id-based-policy-examples-console"></a>
...
To ensure that users and roles can still use the HealthLake console, also attach an IAM  policy to the entities\. For more information, see [Adding permissions to a user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_change-permissions.html#users_change_permissions-add-console) in the *IAM User Guide*\. Users can manage access to the console through the service managed policies **AmazonHealthLakeFullAccess** and **AmazonHealthLakeReadOnlyAccess**\. 
